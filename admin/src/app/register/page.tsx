				...
				<div className="shell show">
					...
					<div className="right">
						...
						<span className="s-badge">
							<span className="s-dot" /> 安全注册
						</span>
						<h2 className="r-title">注册</h2>
						<p className="r-sub">创建账号，开启你的时空之旅。</p>
						...
						>
							<div className="fl">
								...
								<span className="fl-h">4-20 个字符</span>
							</div>
							<Form.Item
								name="username"
								rules={[
									{ required: true, message: "请输入账号" },
									{ min: 4, max: 20, message: "4-20 个字符" },
								]}
							>
								<Input
									placeholder="请输入账号"
							...
							<div className="fl">
								...
								<span className="fl-h">8-32 位，区分大小写</span>
							</div>
							<Form.Item
								name="password"
								rules={[
							...
							<div className="fl">
								<span className="fl-l">确认密码</span>
								<span className="fl-h">再次输入</span>
							</div>
							<Form.Item
								name="confirm"
							...
							>
								<Input.Password
									placeholder="请再次输入密码"
									autoComplete="new-password"
									onFocus={() => setFieldKey("confirm")}
									onBlur={() => setFieldKey(null)}
								/>
							</Form.Item>

							<div className="fl">
								<span className="fl-l">验证码</span>
							</div>
							<div className="cp-row">
								...
								<div className="cp-img" onClick={loadCaptcha} title="点击刷新">
